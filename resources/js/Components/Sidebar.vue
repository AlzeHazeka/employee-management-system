    ...
    >
        <div class="flex h-full flex-col">
            <div :class="headerClasses">
                ...
                >
                    <img src="/images/employee-management-logo.svg" class="h-9 w-9 shrink-0 object-contain" alt="Employee Management System logo" />
                    <div class="leading-tight min-w-0" :class="isCollapsed ? 'md:hidden' : ''">
                        <div class="text-sm font-semibold tracking-wide">Employee Management</div>
                        <div class="text-[11px] text-slate-200/70">Portfolio Demo</div>
                    </div>
                </Link>
